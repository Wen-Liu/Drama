...
public class Constants {
    ...
    public static final String TAG_GET_LOCAL_DATA_TASK = "wen-GetLocalDataTask";

    public static final String BUNDLE_DRAMA = "BundleDrama";
    public static final String SEARCH_SHARED_PREFERENCES = "SearchData";
    public static final String SEARCH_RECORD = "SearchRecord";
    // Url
    public static final String DRAMA_DATA_BASE_URL = "http://www.mocky.io/";
    public static final String DRAMA_DATA_VERSION_URL = "v2/";
    public static final String DRAMA_DATA_GET_URL = "5a97c59c30000047005c1ed2";
